...
import at.game.mechanics.movement.MovementProcessor;
...
public class PlayerController extends AbstractComponent {
	...
	private final float		modifier	= 1f;
	...
	public void update(final float currentSpeed) {
		MovementProcessor.gravityJumpMovement(this.player, this.up, this.down, this.right, this.left, currentSpeed, this.modifier, this.pressingJump,
